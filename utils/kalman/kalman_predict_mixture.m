function [w_out , m_out , P_out] = kalman_predict_mixture(model , w_kin_in , m_kin_in , P_kin_in , pred_model)
    ...
    for midx = 1 : num_models
        ...
        for n = 1 : num_objects
            ...
            elseif pred_model{midx}(1,n)<0 % this is a spawning object
                ...
                % use pred_model to choose Gaussian component of spawn
                dx = model.x_shift(pred_model{midx}(2,n)) ; 
                dy = model.y_shift(pred_model{midx}(2,n)) ; 
